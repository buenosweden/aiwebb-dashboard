...
export default async function KontaktPage() {
  ...
  return (
    <>
      <Topbar pageKicker="Inställningar" pageTitle="Kontaktuppgifter" />
        ...
        <form action={updateContact}>
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Visas automatiskt i sidfot, kontaktformulär och Google-sökresultat.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  placeholder="Gatan 1, 111 22 Stockholm"
                  rows={3}
                />
              </div>
